...
CREATE TABLE info_user(
	...
	FOREIGN KEY(school_id) REFERENCES info_school(school_id),
	FOREIGN KEY(college_id) REFERENCES info_college(college_id)
);
...
CREATE TABLE info_report(
	...
	user_id INT(10),
	comment_id INT(10),
	FOREIGN KEY(comment_id) REFERENCES info_comment(comment_id)
);